...
class DocumentSnapshotPlatform extends PlatformInterface {
  ...
  dynamic get(Object field) {
    ...
    if (!exists) {
      throw StateError(
        'Cannot get field "$field" on a DocumentSnapshotPlatform that does not exist.',
      );
    }
    ...
    dynamic _findComponent(int componentIndex, Map<String, dynamic>? data) {
      ...
      if (value is Map) {
        ...
        throw StateError(
          'Field "${components[componentIndex]}" does not exist within the DocumentSnapshotPlatform.',
        );
      }
    }
